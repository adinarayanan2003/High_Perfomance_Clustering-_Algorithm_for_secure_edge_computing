...
def adaptive_kmeans(data, k_max=10, tolerance=1e-4):
    ...
    for k in range(1, k_max + 1):
        ...
        while True:
            ...
            # Use CUDA for parallelization of element-level operations
            if len(data) > 500:  # You can adjust this threshold based on your data size
            ...
            for idx, new_assignment in enumerate(assignments):
